...
VMarket is a static Claude-assisted marketing-planning dashboard for `IOL`, `Title Sites`, and `Conde Naste`. It runs with plain HTML, CSS, and JavaScript, so it can be deployed directly to GitHub Pages without a backend.

## What It Does

- Starts with a clean, empty planner and three fixed brands
- Uses a Claude strategy intake form to generate campaign direction
...
- The AI workflow uses a browser-stored Claude API key. In a static GitHub Pages app, that key is not protected by a backend.
